...
namespace VasosInteligentes.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signManager, EmailService emailService)
        {
        ...
        public async Task<IActionResult> Login([Required][EmailAddress] string email, [Required] string password)
        {
            if(ModelState.IsValid)
            {
                ...
                if (appuser != null)
                {
                    Microsoft.AspNetCore.Identity.SignInResult result = await _signManager.PasswordSignInAsync(appuser, password, false, false);
                    if(result.Succeeded)
                    {
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            // prepara o link para o envio do e-mail
